...
static int cht_codec_init(struct snd_soc_pcm_runtime *runtime)
{
	...
	*/
	...
	ret = snd_soc_card_jack_new(runtime->card, "Headset",
		jack_type, jack, cht_bsw_jack_pins,
...
static char cht_nau8824_codec_name[16];
...
static int snd_cht_mc_probe(struct platform_device *pdev)
{
	...
	if (i2c_name != NULL) {
		snprintf(cht_nau8824_codec_name, sizeof(cht_nau8824_codec_name),
			"%s%s", "i2c-", i2c_name);
		cht_dailink[dai_index].codec_name = cht_nau8824_codec_name;
	}
